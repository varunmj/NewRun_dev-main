          ...
          <div className="relative mx-auto w-full max-w-sm rounded-2xl border border-white/10 bg-transparent p-4 sm:p-6 overflow-hidden">
            ...
            <button
              ...
              onClick={() => {
                ...
                // Force account selection by adding multiple parameters
                window.location.href = `${apiUrl}/api/auth/google?prompt=select_account&access_type=offline&approval_prompt=force`;
              }}
