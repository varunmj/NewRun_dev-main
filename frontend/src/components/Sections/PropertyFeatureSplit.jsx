// src/components/Sections/PropertyFeatureSplit.jsx
...
export default function PropertyFeatureSplit() {
  const [isVisible, setIsVisible] = useState(false);
  
  const tags = [
    "Studio","1 Bedroom","2 Bedroom","3 Bedroom","Furnished","Unfurnished",
    "Near Campus","Pet Friendly","Utilities Included","Parking","Laundry","WiFi"
  ];
  ...
  return (
    ...
    <section className="nr-dots-fade mx-auto max-w-7xl px-4 pt-10 pb-16">
      ...
      <div className={`mb-8 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        <Pill delay={200}>WHY NEWRUN HOUSING</Pill>
        <h2 className="mt-4 text-4xl font-black tracking-tight sm:text-[44px] bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
          The easiest way to find housing on campus.
        </h2>
        <p className="mt-4 text-white/60 max-w-2xl mx-auto">
          Join thousands of students finding and listing student housing safely and efficiently.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <Panel className="relative overflow-hidden lg:col-span-7" delay={400}>
          ...
          <h3 className="max-w-xl text-[30px] font-extrabold leading-tight sm:text-[34px] bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent">
            Find housing with real classmates
            <br />— no sketchy landlords.
          </h3>

          <p className="mt-4 max-w-xl text-white/80 text-lg leading-relaxed">
            Sign in with your .edu email, browse verified properties, and connect with student landlords.
            Your details stay private until access is approved.
          </p>
        ...
        <div className="flex flex-col gap-5 lg:col-span-5">
          <Panel className="flex items-start gap-4 p-5 sm:p-6 hover:bg-white/[0.02] transition-all duration-300" delay={600}>
            <GlowIcon delay={700}><Svg.Home /></GlowIcon>
            <div>
              ...
              <p className="mt-2 text-white/75 leading-relaxed">Renters and landlords know they're dealing with real classmates.</p>
            </div>
          </Panel>

          <Panel className="flex items-start gap-4 p-5 sm:p-6 hover:bg-white/[0.02] transition-all duration-300" delay={800}>
            <GlowIcon delay={900}><Svg.Map /></GlowIcon>
            <div>
              <p className="text-[12px] font-semibold tracking-wide text-white/60">LOCATION FILTERING</p>
              <h4 className="mt-1 text-[18px] font-semibold text-white">Find what works</h4>
              <p className="mt-2 text-white/75 leading-relaxed">Filter by distance from campus, price range, and amenities — find your perfect match.</p>
            </div>
          </Panel>
